...
def home(): 
    return render_template('index1.html') # this function is returning index.html file
...
def login():  # as soon as this url is directed then call this function
    ...
    return render_template('index1.html',abc = y) # after typing the name, show this name on index.html file where we have created variable abc
